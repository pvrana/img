...
* informationAboutOrder 0..* InformationAboutOrder "A.2.1 - Information about order" """Information about a request (order) for a health service. The message can respond to multiple requests (orders)."""
* identifierOrder 0..1 Identifier "A.2.1.1 - Identifier of request (order)" """Identifier of the health service request (order)."""
* orderDateTime 1..1 dateTime "A.2.1.2 - Date and time of request" """Date and time of entering (issuing) the request (order) for health services."""
